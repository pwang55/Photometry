...
pdf = PdfPages(path + clustername+'_flux_compare_spectra.pdf')
...
# TEMP need to expand this dictionary and write a version for Jan data
...
for x in range(len(cmy)):
    ...
    h = (final_lam < max(lam)) & (final_lam > min(lam)) & (final_type_my == 'sdss')
    ...
    plt.errorbar(final_lam[final_type_my == 'narrowband'], final_flux_my[final_type_my == 'narrowband'], final_fluxerr_my[final_type_my == 'narrowband'], fmt='ro', label='Narrowband Observed Flux')
    plt.errorbar(final_lam[final_type_my == 'sdss'], final_flux_my[final_type_my == 'sdss'], final_fluxerr_my[final_type_my == 'sdss'], fmt='go', label='SDSS Flux from modelMag')

    plt.errorbar(final_lam[final_type_my == 'narrowband'], final_flux_spec[final_type_my == 'narrowband'], fmt='bx', label='Narrowband Flux from SDSS Spectra')
    plt.errorbar(final_lam[final_type_my == 'sdss'], final_flux_spec[final_type_my == 'sdss'], fmt='kx', label='SDSS Flux from Spectra')
