...
mag_c = [int(find_column_list[ci][1])-1 for ci in range(40) if find_column_list[ci][2]=='MAG_AUTO'][0]
fwhm_c = [int(find_column_list[ci][1])-1 for ci in range(40) if find_column_list[ci][2]=='FWHM_IMAGE'][0]
peak_c = [int(find_column_list[ci][1])-1 for ci in range(40) if find_column_list[ci][2]=='FLUX_MAX'][0]

#print mag_c, fwhm_c, peak_c
